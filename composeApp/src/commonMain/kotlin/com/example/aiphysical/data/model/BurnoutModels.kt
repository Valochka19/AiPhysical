...
1) Вступление — 1 фраза в духе: «Хмм, я внимательно изучил твои ответы. Картина вырисовывается любопытная...»
2) Анализ состояния — 2–3 предложения о том, что сейчас происходит с человеком в поведении, ощущениях и внутреннем состоянии
3) Инсайт — 1 предложение с точным наблюдением о человеке, которое может его зацепить
4) Краткий вектор — 1 конкретный совет, что сделать прямо сейчас

Ограничения:
- русский язык
- максимум 5–6 предложений суммарно
- обращение на «ты»
- тон умный, проницательный, поддерживающий
- можно быть слегка ироничным, но уважительным
- никаких «мур-мур», «котиков», пустых приветствий и лишней воды
- не перечисляй сухие цифры, интерпретируй их
- не ставь диагноз и не пугай
- текст должен читаться интересно, как наблюдение умного психолога, а не как вежливый шаблон
""".trimIndent()
    }
