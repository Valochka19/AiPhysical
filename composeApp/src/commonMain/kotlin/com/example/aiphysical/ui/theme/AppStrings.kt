...
fun getStrings(lang: AppLanguage): Strings = when (lang) {
    AppLanguage.KZ -> Strings(
        ...
        aiAssistantTitle = "Уми", aiInsightLoading = "Деректер талдануда...",
        ...
        viewStats = "Статистика", aiRecommended = "Уми Ұсынады",
    ...
    AppLanguage.RU -> Strings(
        ...
        aiAssistantTitle = "Уми", aiInsightLoading = "Анализируем данные...",
        ...
        viewStats = "Статистика", aiRecommended = "Уми Рекомендует",
    ...
    AppLanguage.EN -> Strings(
        ...
        aiAssistantTitle = "Umi", aiInsightLoading = "Analyzing data...",
        ...
        viewStats = "Stats", aiRecommended = "Umi Recommends",
